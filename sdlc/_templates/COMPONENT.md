...
node_definitions: [] # NDF IDs this component has authored (e.g., [FDE-NDF-001, FDE-NDF-002]); empty when the component uses only the engine-default 15-type catalog. Per ADR-039.
created: YYYY-MM-DD
---
...
lifecycle) for shapes the engine-default 15-type catalog does not cover.
...
Empty when the component uses only the engine-default 15-type catalog.
