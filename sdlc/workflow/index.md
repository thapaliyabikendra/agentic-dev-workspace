...
| [prototype-eval-rubric.md](prototype-eval-rubric.md) | Advisory prototype evaluation — six scored dimensions, severity tiers with consequence classes, 5-field finding shape, dated immutable reports, confidence disclosure | After a `prototype-generation.md` Sub-flow A/B pass, at BA review, or when `review.md` scopes prototype screens — never gates the adoption flip |
