...
/                          ← workspace root
  ...
  /docs                    project knowledge base
    ...
    /prototypes            Karpathy-catalogued prototype artifacts (lazy)
      index.md             ← Karpathy catalog over all prototypes
      /<slug>              ← one folder per prototype (lazy)
        PROTO-<slug>.md    ← prototype descriptor
        /raw               ← verbatim prototype artifact(s) (lazy)
