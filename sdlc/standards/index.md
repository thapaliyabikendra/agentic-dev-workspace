...
| [STD-002](STD-002-dotnet-coding-conventions.md) | Engine-level .NET implementation conventions (5 rules — see file § Scope) | accepted | api | dotnet, application-layer, errororstd, validation, localization, repository-query, encapsulation, convention | seed |
